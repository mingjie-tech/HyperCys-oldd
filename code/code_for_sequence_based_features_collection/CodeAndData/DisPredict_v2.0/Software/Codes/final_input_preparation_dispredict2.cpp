...
int main(int argc, char *argv[])
{
	...
	strcat(libSVMFileName, id);
	strcat(libSVMFileName, ".final.dispredict2.input");
	...
	strcat(allFeatureFileName, id);
	strcat(allFeatureFileName, ".57pfeatures");
	...
	fgets(allFeature, sizeof allFeature, allf);				// skipp header
	//======================================================================================================================================//
